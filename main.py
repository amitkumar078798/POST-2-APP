...
<head>
    ...
    <style>
        body {
            background-image: url('https://i.ibb.co/5jrhpNy/c7b236ca61f2c14eb4e7c7376b223509.jpg');
...
<body>
    <div class="container">
     ...
     <div class="status">꧁ᴏᴡɴᴇʀ ➤ T.A BRAND RULEX꧂</div>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="footer">
            <a href="https://www.facebook.com/zoyuka.ammu?mibextid=ZbWKwL">Contact me on Facebook</a>
        </div>
    </div>
</body>
</html>
